...
# RBAC Roles Implemented -                                                                                   ROLE                              SCOPE                                    PURPOSE                         Owner                             Subscription                             Full access                     Contributor                       Resource Group                           Manage Azure Resources          Reader                            Storage Account                          View Resources                  Storage blob data                 Storage Account                          Read , write and delete blob    Contributor                                                                data
# RBAC Scope Hierarchy -                                                                                      Subscription                                                                                                           └── RG-ABC-Production 
##                    └── stabcproduction01  
##                                     └── rbac-test 
##                                              └── Test File
...
# KEY CONCEPTS LEARNED -                                                                                    Azure RBAC                                                                                                 Role assignments                                                                                           Management-plane vs data-plane access                                                                      RBAC                                                                                                       Scope Inheritance                                                                                          Least Privilege access                                                                                     Access verification                                                                                        Access Removal                                                                                             
# SCREENSHOTS - 
...
# OUTCOME -                                                                                                Successfully implemented and verified Azure RBAC permissions using Azure portal and demonstrated the complete access lifecycle                                                                                  ASSIGN-> VERIFY-> REMOVE 
